...
%% FVD: copy/pasted from slides/sysdev-hw-devices/sysdev-hw-devices.tex
\begin{frame}{Device Tree: using the blob}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.4\textwidth}
    \includegraphics[height=0.8\textheight]{slides/kernel-hw-devices/ram.pdf}
  \end{columns}
\end{frame}
...
\begin{frame}{Device Tree design principles}
  ...
  \item {\bf OS-agnostic}
    ...
    \item The Device Tree is de facto part of the kernel ABI
    \end{itemize}
