...
\begin{frame}[fragile]
  ...
  Minimum locking requirements (see \kdochtml{kernel-hacking/locking}):
...
% Legends:
\begin{itemize}
 \item SLIS: \kfunc{spin_lock_irqsave}
 \item SLI: \kfunc{spin_lock_irq}
 \item SL: \kfunc{spin_lock}
 \item SLBH: \kfunc{spin_lock_bh}
 \item MLI: \kfunc{mutex_lock_interruptible}
\end{itemize}
\end{footnotesize}

For spinlocks: you can always use \kfunc{spin_lock_irqsave} if not sure
