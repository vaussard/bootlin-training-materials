...
\begin{frame}[fragile]
  \frametitle{Sleeping summary}
\begin{table}
\begin{tabular}{l|c|c|c|c}
                            & \textbf{Wait queue}  & \textbf{Completion}  & \textbf{msleep()}    & \textbf{udelay()}  \\ 
\hline
\textbf{Use in interrupt}   & Wake-up only         & Wake-up only         & NO!                  & Keep it short      \\ 
\hline
\textbf{Schedule latency}   & Scheduled            & Scheduled            & Scheduled            & No                 \\ 
\hline
